...
# parser.add_argument('--pth_path', type=str, default='./checkpoints/BIR_res2net/BIRNet-4.pth')
parser.add_argument('--pth_path', type=str, default='pre-weight/BIR_res2net.pth')

for _data_name in ['CAMO', 'CHAMELEON', 'COD10K', 'NC4K']:
    data_path = './DATA/TestDataset/{}'.format(_data_name)
    save_path = './results/res2net/{}/'.format(_data_name)
