...
def train(train_loader, model, optimizer, epoch):
    ...
    for i, pack in enumerate(train_loader, start=1):
        ...
        # ---- forward ----
        lateral_map_4, lateral_map_3, lateral_map_2, lateral_map_1, edge_map_4, edge_map_3, edge_map_2, edge_map_1 = model(images)
        # ---- loss function ----
...
if __name__ == '__main__':
    ...
    # ---- build models ----
    model = Net().cuda()
    pre_path = 'pre-weight/swin_base_patch4_window12_384_22k.pth'
