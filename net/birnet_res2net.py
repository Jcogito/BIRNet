...
class CCM(nn.Module):
    def __init__(self, inchannel, channel):
        ...
        self.conv1d = CBR3X3(inchannel, channel)
        self.conv1d_e = CBR3X3(inchannel, channel)
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.ggm = GGBlock(2048)

        self.ccm4 = CCM(2048, 256)
        self.ccm3 = CCM(1024, 128)
        self.ccm2 = CCM(512, 64)
        self.ccm1 = CCM(256, 32)
        ...
        self.bone3 = Ubone(256, 128)
        self.bone2 = Ubone(128, 64)
        self.bone1 = Ubone(64, 32)

        self.decoder4 = decoder(256)
