...
from net.birnet_swin import Net
from utils.tdataloader import test_dataset

parser = argparse.ArgumentParser()
parser.add_argument('--testsize', type=int, default=384, help='testing size')
parser.add_argument('--pth_path', type=str, default='pre-weight/BIR_swin.pth')

for _data_name in ['CAMO', 'CHAMELEON', 'COD10K', 'NC4K']:
    data_path = 'D:/model/DATA/COD/TestDataset/{}/'.format(_data_name)
    save_path = './results/swin/{}/'.format(_data_name)
